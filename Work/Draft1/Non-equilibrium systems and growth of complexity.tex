...
Linear irreversible thermodynamics bases and extends the 19th century concepts of equilibrium thermodynamics to systems that are sufficiently close to equilibrium in such a way that the equilibrium state variables serve as an good local approximation of the true state variables.  
