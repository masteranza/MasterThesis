...
In order to provide further information on the behaviour of the dissipation, one should consider a system where multiple steady state solutions are known to exist. One such model was investigated by \cite{Zhang:2001jc} who considered heat flow in a one-dimensional lattice. The two possible steady states exist and depend on the initial conditions: a soliton and a diffusive heat flow. 
In this case the state with maximum dissipation should stay the same at all field strengths, however at low fields, the soliton does not form whereas at high fields it does.
