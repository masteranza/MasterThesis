...
Even at steady state the difficulties seem to pile up as the basic state functions, such as temperature or entropy cease to exist outside of near equilibrium and the distribution functions appear fractal and non-analytic (Dewar, Lineweaver, Niven, & Regenauer-Lieb, 2014).
...
Prigogine himself noted (Prigogine, 1979):
...
Dewar and Maritan (Dewar et al., 2014) showed using Jaynes's maximum entropy method that a state of minimum dissipation (MinEP) is selected for a system without dynamic instability, whereas that of maximum dissipation (MaxEP) is selected for a system with dynamic instability.
...
It's usage can be usually justified by assuming analyticity of thermodynamic state functions arbitrarily close to equilibrium - then, local equilibrium is obtained from first order expansion of thermodynamic properties in the irreversible fluxes ${X_i}$ (Evans & Rondoni, 2002).
...
This spontaneous production of entropy is given by the entropy production per unit volume $\sigma$ by the following expression (De Groot & Mazur, 1984)
\begin{displaymath}
...
The first time-reversible, deterministic thermostats and ergostats were invented in the early 1980s by Hoover, Ladd and Moran . Prior to this development there was no satisfactory mathematical way of modelling thermostatted non-equilibrium steady states. (Hoover, Ladd, & Moran, 1982)
...
The dissipation function serves as mathematical replacement for the entropy production. When entropy production can be defined, it is equal, on average, to the dissipation function. The main advantage though is that, unlike the entropy production, the dissipation function can, for ergodically consistent systems be always well defined (Evans, 2016).
...
It was also verified experimentally, see Wang(2002)(Wang, Sevick, Mittag, Searles, & Evans, 2002), Carberry(2007)(Carberry, Baker, & Wang, 2007)
...
also known as Non-equilibrium Partition Identity (NPI) was first implied for Hamiltonian systems by Yamada and Kawasaki (1967) (Yamada & Kawasaki, 1967) and is stated as:
...
The conjecture of maximum entropy production (MEP) has shown some promising (but controversial) success in studies of planetary climates (Paltridge, Farquhar, & Cuntz, 2007), fluid turbulence  (MALKUS, 2003), crystal growth morphology, biological evolution and adaptation  as well as earthquake dynamics. %TODO: Fill the references from chapter 3, Beyond the Second Law
...
The dissipation function is similar to the entropy production, and although it is not directly connected to a state function, the various fluctuation theorems provide exact, non-equilibrium relations. Given this similarity it is interesting to consider whether there exists a principle akin to MaxEnt (maximum entropy) for equilibrium systems, and MEP (maximum entropy production rate) for non-equilibrium systems. There were several papers on the topic, including Williams and Evans (Williams & Evans, 2008), concluding that MEP cannot be applied rigorously to non-equilibrium systems in general, as the distribution function at any time (including steady state) is not just a function of the dissipation at that time. However it might provide a good approximation in some cases.
...
In fact it was shown in (Brookes, Reid, & Evans, 2011) through numerical simulations, that the dissipation average peaks before dropping to a steady state for most field values. Therefore it is clear that the instantaneous dissipation is not a maximum in the steady state - the system evolves through unstable (transient) maximum. For stronger fields, the steady state reaches a higher instantaneous dissipation which is also maximum.
...
Brookes, S. J., Reid, J. C., & Evans, D. J. (2011). The fluctuation theorem and dissipation theorem for Poiseuille flow. Journal of Physics: …, 297, 012017. http://doi.org/10.1088/1742-6596/297/1/012017
Carberry, D. M., Baker, M., & Wang, G. M. (2007). An optical trap experiment to demonstrate fluctuation theorems in viscoelastic media. Journal of Optics a: …, 9(8), S204–S214. http://doi.org/10.1088/1464-4258/9/8/s13
De Groot, S. R., & Mazur, P. (1984). Non-Equilibrium Thermodynamics. New York: Dover.
Dewar, R. C., Lineweaver, C. H., Niven, R. K., & Regenauer-Lieb, K. (2014). Beyond the Second Law: An Overview. In Beyond the Second Law (pp. 3–27). Berlin, Heidelberg: Springer Berlin Heidelberg. http://doi.org/10.1007/978-3-642-40154-1_1
Evans, D. J. (1985). Response theory as a free-energy extremum. Physical Review A, 32(5), 2923–2925. http://doi.org/10.1103/PhysRevA.32.2923
Evans, D. J. (2016). Fundamentals of Classical Statistical Thermodynamics, 1–223.
Evans, D. J., & Rondoni, L. (2002). Comments on the Entropy of Nonequilibrium Steady States. Journal of Statistical Physics, 109(3/4), 895–920. http://doi.org/10.1023/A:1020435219996
Evans, D. J., & Searles, D. J. (2002). The Fluctuation Theorem. Advances in Physics, 51(7), 1529–1585. http://doi.org/10.1080/00018730210155133
Hoover, W. G., Ladd, A. J. C., & Moran, B. (1982). High-Strain-Rate Plastic Flow Studied via Nonequilibrium Molecular Dynamics. Physical Review Letters, 48(26), 1818–1820. http://doi.org/10.1103/PhysRevLett.48.1818
Maeda, A., & Munakata, T. (1995). Lattice thermal conductivity via homogeneous nonequilibrium molecular dynamics. Physical Review E, 52(1), 234–239. http://doi.org/10.1103/PhysRevE.52.234
MALKUS, W. V. R. (2003). Borders of disorder: in turbulent channel flow. Journal of Fluid Mechanics, 489, 185–198. http://doi.org/10.1017/S0022112003004907
Paltridge, G. W., Farquhar, G. D., & Cuntz, M. (2007). Maximum entropy production, cloud feedback, and climate change. Geophysical Research …, 34(14), 3445. http://doi.org/10.1029/2007GL029925
Prigogine, I. (1979). From Being to Becoming: Time and Complexity in the Natural Sciences. San Francisco: WH Freeman & Co. Proust.
Wang, G. M., Sevick, E. M., Mittag, E., Searles, D. J., & Evans, D. J. (2002). Experimental Demonstration of Violations of the Second Law of Thermodynamics for Small Systems and Short Time Scales. Physical Review Letters, 89(5), 128–4. http://doi.org/10.1103/PhysRevLett.89.050601
Williams, S. R., & Evans, D. J. (2008). Time-dependent response theory and nonequilibrium free-energy relations. Physical Review E, 78(2), 021119–7. http://doi.org/10.1103/PhysRevE.78.021119
Yamada, T., & Kawasaki, K. (1967). Nonlinear Effects in the Shear Viscosity of Critical Mixtures. Progress of Theoretical Physics, 38(5), 1031–1051. http://doi.org/10.1143/PTP.38.1031
Zhang, F., Isbister, D. J., & Evans, D. J. (2001). Multiple nonequilibrium steady states for one-dimensional heat flow. Physical Review E, 64(2), 1645–5. http://doi.org/10.1103/PhysRevE.64.021102
