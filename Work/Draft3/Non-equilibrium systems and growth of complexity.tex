...
\subsection{Energy landscape traversal}
...
where $\Phi$ holds all higher order terms of the cumulant expansion. From the convexity of the exponential function one might check that we must have $\Phi \geq 0$. Thus, $\Phi$ can be thought of as a correction due to the dispersion of the dissipated work distribution about the average $\beta \langle W_d \rangle $ that gives the heaviest weight to the leftward tail of the work distribution.\cite{Jarzynski:2006cq}

One might now argue that $\langle W_d \rangle $ can be connected with drift through oscillatory energy barriers depending on the model, this in fact recently demonstrated by Nikolay Perunov at al.\cite{Perunov:2016hl} 
