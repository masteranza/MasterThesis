...
However in 1970s, Charles Bennett pointed out that it is not the case\cite{Bennett:1973ko}, laying some early groundwork for relating computational and thermodynamic ideas. This topic however will not be developed in this work.
...
where $\sigma$ is entropy production source per unit volume.
...
The steady state is loosely defined as an emergent  state of a driven system (in case of non-driven systems the steady state corresponds to equilibrium), which properties stabilized after a sufficiently long time. 

More formally one can impose a condition of vanishing expectation value of $\partial \rho / \partial t$ over the probability density function $p(\rho)$ and non-vanishing expectation value of fluxes vector $\bm{f}$ over the probability density function $p(\bm{f})$\cite{Dewar:2014ek}, i.e.
\begin{equation}
\begin{aligned}
\label{SteadyStates}
...
\end{equation}
\todo{This is true at no field or a constant field - Beyond the second law page 37}
