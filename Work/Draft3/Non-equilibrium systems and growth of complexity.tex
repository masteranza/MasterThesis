...
%Where is entropy production coming from?
%Answer: Entropy production is not dependent on coarse-graining \cite{Gilbert:1999ff} \cite{Goldstein:1998ip}
...
This stays in contrast with time-reversibility of the thermostatted equations of motion.
...
One might now argue that $\langle W_d \rangle $ can be connected with drift through oscillatory energy barriers depending on the model, this in fact recently demonstrated by Nikolay Perunov et al\cite{Perunov:2016hl}.
