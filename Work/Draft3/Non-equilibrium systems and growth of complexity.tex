...
Lord Rayleigh began the search before him (without posing the question). During the study of jets of water from a nozzle, Rayleigh \cite{Rayleigh:1878hb} noticed that a jet can settle into a conditionally stable state, however it is likely to suffer a fluctuation passing to another, less unstable, but still, conditionally stable state. 
Similar reasonings was used by him in a study of Bénard convection \cite{Rayleigh:1916fa}. 
\todo{DOPISZ INNE PROPOZYCJE}

The physically lucid considerations of Rayleigh seem to contain the heart of the distinction between the principles of minimum and maximum rates of dissipation of energy and entropy production, which have been developed in the course of physical investigations on so-called MaxEP principle by later authors.
