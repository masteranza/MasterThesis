...
%One may show that the probabilities for selecting macrostate 2 over macrostate 3 would be exactly the same if we were to use the Fluctuation theorem protoplast.
